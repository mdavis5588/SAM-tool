-- Migration 16: Add new alert types to get_compliance_alerts()
-- Adds: NEW_SERVER_DETECTED, VMWARE_SERVER_NO_ULA, HARDWARE_INCREASE,
--       HARDWARE_DECREASE, NEW_OPTION_ENABLED
...
BEGIN
  ...
  -- -------------------------------------------------------------------------
  -- Per-contract / shared alerts (no schema loop needed)
  -- -------------------------------------------------------------------------
