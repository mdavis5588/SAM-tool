...
-- ---------------------------------------------------------------------------
-- STALE SERVER INVESTIGATIONS (migration 13)
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sam_admin.stale_server_investigations (
    ...
    resolved_by       TEXT,
    UNIQUE (client_schema, server_id)
);
...
-- ---------------------------------------------------------------------------
-- DECOMMISSIONED SERVERS ARCHIVE (migration 14)
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sam_admin.decommissioned_servers (
    ...
    licence_snapshot  JSONB       NOT NULL DEFAULT '[]',
