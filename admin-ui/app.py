...
def _process_csv_upload(schema: str, files) -> dict:
    ...
    base_payload = {
        ...
        "cpu_sockets":          max(1, _safe_int(server_row.get("cpu_sockets"))),
        "cpu_cores_per_socket": max(1, _safe_int(server_row.get("cores_per_socket"))),
        "cpu_threads_per_core": max(1, _safe_int(server_row.get("threads_per_core"))),
        "vcpu_count":           max(1, _safe_int(server_row.get("vcpu_count"))),
